	...
	if( IsQuestFloor ){
		...
		if( lairQuest.questFloorNumber == QuestFloorIndex 
			...
			&& MonstersCount == 4 ){
				...
				switch(player.ClassID){
				case PC_0_WARRIOR:
				case PC_5_FIGHTER:soundMessage = S_811_WAR_81;	break;
				case PC_1_ARCHER:
		...
		if( player.CurAction == PCA_0_NOTHING ){
			...
			if( nextLocIndex != QF_0 ){
				if( MonstersCount <= 4 ){
					...
					switch( player.ClassID ){
					case PC_0_WARRIOR:
					case PC_5_FIGHTER:soundMessage = S_772_WAR_43;	break;
					case PC_1_ARCHER:
...
void __fastcall SayMessageOnBossKill(int monsterIndex, int isNetData)
{
	...
	if( baseMonsterIndex == BM_50_SKELETON_LORD ){
		...
		switch( player.ClassID ){
			case PC_0_WARRIOR:
			case PC_5_FIGHTER:	SoundMessage = S_812_WAR_82 ;		break;
			case PC_1_ARCHER:
	...
	if( bossIndex == 579 ){
		...
		switch( player.ClassID ){
			case PC_0_WARRIOR:
			case PC_5_FIGHTER:	soundMessage = S_814_WAR_84 ;		break;
			case PC_1_ARCHER:
	...
	if( bossIndex == 582 ){
		...
		switch( player.ClassID ){
		case PC_0_WARRIOR:
		case PC_5_FIGHTER:SoundMessage = S_815_WAR_85;	break;
		case PC_1_ARCHER:	
	...
	if( baseMonsterIndex == BM_51_THE_BUTCHER ){
		...
		switch( player.ClassID ){
		case PC_0_WARRIOR:
		case PC_5_FIGHTER:SoundMessage = S_810_WAR_80 ;	break;
		case PC_1_ARCHER:
	...
	if( !strcmp(monster.Name, UniqueMonsters[UM_0_Gharbad_the_Weak].NamePtr) ){
		...
		switch( player.ClassID ){
			case PC_0_WARRIOR:
			case PC_5_FIGHTER:	SoundMessage = S_790_WAR_61 ;		break;
			case PC_1_ARCHER:
	...
	if( !strcmp(monster.Name, UniqueMonsters[UM_2_Zhar_the_Mad].NamePtr) ){
		...
		switch( player.ClassID ){
			case PC_0_WARRIOR:
			case PC_5_FIGHTER:	SoundMessage = S_791_WAR_62 ;		break;
			case PC_1_ARCHER:
	...
	if( !strcmp(monster.Name, UniqueMonsters[UM_4_ArchBishop_Lazarus].NamePtr) && MaxCountOfPlayersInGame != 1 ){
		...
		switch( player.ClassID ){
			case PC_0_WARRIOR:
			case PC_5_FIGHTER:	SoundMessage = S_813_WAR_83 ;		break;
			case PC_1_ARCHER:
	...
	if( !strcmp(monster.Name, UniqueMonsters[UM_8_Warlord_of_Blood].NamePtr) ){
		...
		switch( player.ClassID ){
			case PC_0_WARRIOR:
			case PC_5_FIGHTER:	SoundMessage = S_824_WAR_94 ;		break;
			case PC_1_ARCHER:
