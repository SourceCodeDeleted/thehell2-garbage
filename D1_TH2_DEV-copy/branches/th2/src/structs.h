...
{ // *006EAE14
	...
	int someNewBigDataArray[1000];
	uchar       subclassID         _(subclassID);
	uchar       specializationID  _(specializationID);


	#endif
};
end_(Player); check_size(Player, 25962);//qndel - was 21960
...
struct PlayerInfo4 : PlayerInfo3
{
	int someNewBigDataArray[1000];
		uchar       subclassID;
		uchar       specializationID;
};
#else
typedef PlayerInfo PlayerInfo2;
typedef PlayerInfo PlayerInfo3;
typedef PlayerInfo PlayerInfo4;
#endif
