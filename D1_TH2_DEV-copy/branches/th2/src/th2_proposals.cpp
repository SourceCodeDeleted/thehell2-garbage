...
// 0 Paladin
	{
	ClassNamePtrs[PC_0_WARRIOR],			// NamePtr
	{ InitialStr[PC_0_WARRIOR],  InitialMag[PC_0_WARRIOR], InitialDex[PC_0_WARRIOR], InitialVit[PC_0_WARRIOR] },	// StartStats
	//MaxStat[PC_0_WARRIOR],	// MaxStats
	ClassBlockBonusTable[PC_0_WARRIOR],		// Block
	NumberOfSubStepsByClass[PC_0_WARRIOR],	// SubSteps
...
// 1 Scout
	{
	ClassNamePtrs[PC_1_ARCHER],			// NamePtr
	{ InitialStr[PC_1_ARCHER],  InitialMag[PC_1_ARCHER], InitialDex[PC_1_ARCHER], InitialVit[PC_1_ARCHER] },	// StartStats
	//MaxStat[PC_1_ARCHER],	// MaxStats
	ClassBlockBonusTable[PC_1_ARCHER],		// Block
	NumberOfSubStepsByClass[PC_1_ARCHER],	// SubSteps
...
// 4 Assassin
	{
	ClassNamePtrs[PC_4_ROGUE],			// NamePtr
	{ InitialStr[PC_4_ROGUE],  InitialMag[PC_4_ROGUE], InitialDex[PC_4_ROGUE], InitialVit[PC_4_ROGUE] },	// StartStats
	//MaxStat[PC_4_ROGUE],	// MaxStats
	ClassBlockBonusTable[PC_4_ROGUE],	// Block
	NumberOfSubStepsByClass[PC_4_ROGUE],	// SubSteps
...
// 5 Gladiator
	{
	ClassNamePtrs[PC_5_FIGHTER],		// NamePtr
	{ InitialStr[PC_5_FIGHTER],  InitialMag[PC_5_FIGHTER], InitialDex[PC_5_FIGHTER], InitialVit[PC_5_FIGHTER] },	// StartStats
	//MaxStat[PC_5_FIGHTER],	// MaxStats
	ClassBlockBonusTable[PC_5_FIGHTER],	// Block
	NumberOfSubStepsByClass[PC_5_FIGHTER],// SubSteps
