...
void SaveGame()
{
...

	{
		...
		outfile << "save game\n";
		outfile << "first encoded len: " << newSaveSize << "\n";
		outfile << "second encoded len: " << saveSize << "\n";
		outfile << "normal len: " << (CurSaveData - ptrSaveData) << "\n";
		outfile << "should be: " << (362147 + sizeof(Player) - 21960 - 372 * 128 + sizeof(Item)*countof(ItemsOnGround) + 4) << "\n";
