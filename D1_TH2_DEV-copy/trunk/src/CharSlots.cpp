...
void __fastcall WriteHeroDataToSave( void* heroData )
{
	...
	int blockSize = RoundBlockSizeTo64(sizeof(PlayerInfo3));
	uchar* heroBuffer = (uchar*)AllocMem(blockSize);
	memcpy(heroBuffer, heroData, sizeof(PlayerInfo3));
	EncodeSave(heroBuffer, sizeof(PlayerInfo3), blockSize, key);
...
{
	PlayerInfo3 charInfo;// [sp+Ch] [bp-4F4h]@8
