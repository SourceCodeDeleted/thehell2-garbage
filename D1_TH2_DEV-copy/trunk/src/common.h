...
enum Game_Param: uint { CurVersion = th2 ? 12 : 0 }; // при релизе архив версий можно будет очиситить и запретить загружать старые версии, либо сделать релизный идентификатор сейвов 'HEL2'
...
SS(Item, 8, 889, 4, 877, 3, 581, 2, 555, 1, 372 ) // 9-12, 1081 (добавлять слева в массив индекс старшей
SS(Player, 11, 73764, 10, 73760, 9, 73752, 8, 60824, 7, 56984, 6, 56728, 5, 56216, 4, 55488, 3, 35952, 2, 34144, 1, 23076, 0, 21960 ) // 12, 106224
#undef SS
