...
void __fastcall MaybeInitQuestBook( int objectIndex, int bookIndex )
{
	...
	if( bookIndex <= 5 ){
		...
		if( bookIndex == 6 ){
			...
			case PC_0_PALADIN:
			case PC_5_GLADIATOR:		object.MaybeSpeechIndex = SP_323;		break;

			case PC_1_SCOUT:			object.MaybeSpeechIndex = SP_332;		break;

			case PC_2_MAGE:				object.MaybeSpeechIndex = SP_329;		break;

			case PC_3_MONK:				object.MaybeSpeechIndex = SP_326;		break;

			case PC_4_ASSASSIN:			object.MaybeSpeechIndex = SP_335;		break;
			}
		}else if( bookIndex == 7 ){
			switch (player.ClassID ){
			case PC_0_PALADIN:
			case PC_5_GLADIATOR:		object.MaybeSpeechIndex = SP_324;		break;

			case PC_1_SCOUT:			object.MaybeSpeechIndex = SP_333;		break;

			case PC_2_MAGE:				object.MaybeSpeechIndex = SP_330;		break;

			case PC_3_MONK:				object.MaybeSpeechIndex = SP_327;		break;

			case PC_4_ASSASSIN:			object.MaybeSpeechIndex = SP_336;		break;
			}
		}else if( bookIndex == 8 ){
			switch (player.ClassID ){
			case PC_0_PALADIN:
			case PC_5_GLADIATOR:		object.MaybeSpeechIndex = SP_325;		break;

			case PC_1_SCOUT:			object.MaybeSpeechIndex = SP_334;		break;
			case PC_2_MAGE:				object.MaybeSpeechIndex = SP_331;		break;
			case PC_3_MONK:				object.MaybeSpeechIndex = SP_328;		break;
			case PC_4_ASSASSIN:			object.MaybeSpeechIndex = SP_337;		break;
			}
		}
		object.bookIndex = bookIndex;
...
void __fastcall ActivateMythicalBook( int playerIndex, int objectIndex )
{
	...
	switch (Players[CurrentPlayerIndex].ClassID ){
	case PC_0_PALADIN:		
	case PC_5_GLADIATOR:	speechIndex = SP_235;		break;
	case PC_1_SCOUT:		speechIndex = SP_243;		break;
	case PC_4_ASSASSIN:		speechIndex = SP_263;		break;
...
void __fastcall ActivateLargeOgdenQuestChest( int playerIndex, int objectIndex )
{
	if( Quests[Q_7_OGDENS_SIGN].status2 == 2 ){
		...
		switch (Players[CurrentPlayerIndex].ClassID ){
		case PC_0_PALADIN:		
		case PC_5_GLADIATOR:	soundIndex = S_753_WAR_24;		break;
		case PC_1_SCOUT:		
		case PC_4_ASSASSIN:		soundIndex = S_644_ROG_24;		break;
...
void __fastcall ActivateSlainHero_TH( int playerIndex, int objectIndex )
{
	...
	if( Objects[ objectIndex ].selectable ){
		...
		if( LoadingNetData == 0 ){
			...
			case PC_0_PALADIN  : itemGfxId = By( Difficulty,   70,  220,   24 ); sound = S_732_WAR_09; itemCode = IC_4_MACE;   break;
			case PC_1_SCOUT    : itemGfxId = By( Difficulty,  219,  108, 1500 ); sound = S_629_ROG_09; itemCode = IC_3_BOW;    break;
			...
			case PC_4_ASSASSIN : itemGfxId = By( Difficulty, 1367,  912,  357 ); sound = S_629_ROG_09; itemCode = IC_1_SWORD;  break;
			case PC_5_GLADIATOR: itemGfxId = By( Difficulty,  104,  211,  142 ); sound = S_732_WAR_09; itemCode = IC_2_AXE;    break;
			}
			if( itemGfxId ){
...
void __fastcall ApplyShrineEffect( int playerIndex, int objectIndex, int soundIndex )
{
	...
	case SH_26_Oily:// 00452BEA
		...
		switch (player.ClassID ){
		case PC_0_PALADIN:		ModifyPlayerStrength(CurrentPlayerIndex, 2);	break;
		case PC_1_SCOUT:		ModifyPlayerDexterity(CurrentPlayerIndex, 2);	break;
		...
		case PC_4_ASSASSIN:		ModifyPlayerDexterity(CurrentPlayerIndex, 1);
								ModifyPlayerMagic(CurrentPlayerIndex, 1);		break;
		case PC_5_GLADIATOR:	ModifyPlayerVitality(CurrentPlayerIndex, 2);	break;
		}
		CheckStatsOnShrine(playerIndex);
