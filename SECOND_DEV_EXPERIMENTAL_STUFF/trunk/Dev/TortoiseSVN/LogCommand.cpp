...
bool LogCommand::Execute()
{
	...
	if( cmdLinePath.m_sFwdslashPath.Replace( L"C:/Dev/TheHell/", L"C:/Dev/Local/TheHell/" ) || (cmdLinePath.m_sFwdslashPath == L"C:/Dev/TheHell" && cmdLinePath.m_sFwdslashPath.Replace( L"C:/Dev/TheHell", L"C:/Dev/Local/TheHell" ) ) ){
		cmdLinePath.m_sUTF8FwdslashPath.Replace( "C:/Dev/TheHell", "C:/Dev/Local/TheHell" );
		for(auto& p: pathList.m_paths){
			if( ! p.m_sFwdslashPath.Replace( L"C:/Dev/TheHell", L"C:/Dev/Local/TheHell" ) ){
				break;
			}
		}
	}
